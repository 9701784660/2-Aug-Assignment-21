...
namespace _2_8_Assignment_21
{
    ...
    class Program
    {
        ...
        "Apple", "Guava", "Orange", "Grapes", "Watermelon", "Strawberry", "Mango", "Pineapple", "Papaya", "Blueberry"
    };
        ...
        { "Destiny", "Things that happen to you in your Life,especially things that you cannot control ." }
    };
